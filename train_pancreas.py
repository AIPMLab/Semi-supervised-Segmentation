...
parser.add_argument('--root_pathlist', type=str, default=r'D:\lyytest\SSL-contrastive-main\dataset\Pancreas', help='Name of Experiment')
...
if __name__ == "__main__":
    ...
    for epoch_num in tqdm(range(max_epoch), ncols=70):
        ...
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            lurp_loss = uncertainty_rectified_loss(r_outputs, v_outputs, T=0.5)
            ...
            consistency_loss_value = consist_loss(v_outputs_soft, r_outputs_soft)
